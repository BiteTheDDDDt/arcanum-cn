 ...
 */
export const move = (array, index, amount) => {
    // Validate arguments
    if (index < 0 ||
        index >= array.length ||
 ...
 */
export const moveElm = (array, element, amount) => {
 ...
 */
export const mergeInto = (array, itemsToMerge, predicate) => {
 ...
 */
export const randBetween = (array, lowerLimit = 0, upperLimit = array.length) => {
 ...
 */
export const mapNonNull = (array, predicate) => {
 ...
 */
export const pushNonNull = (array, valuesToPush) => {
 ...
 */
export const findRemove = (array, predicate) => {
    // Iterate through the array
    for (let i = 0; i <= array.length - 1; i++) {
 ...
 */
export const randWhere = (array, predicate) => {
 ...
 */
export const quickSplice = (array, index) => {
 ...
 */
export const propSort = (array, propertyName) => {
    array.sort((a, b) => {
        const propA = a[propertyName]; // When casting types, they must be cast first to unknown. It's a quirk of ts.
 ...
 */
export const binarySearch = (array, target, property, comparator) => {
    ...
    const compare = comparator !== null && comparator !== void 0 ? comparator : defaultComparator;
    let left = 0;
    ...
    while (left <= right) {
        ...
        let comparison;
        if (property) {
            comparison = compare(element[property], target);
        }
        else {
            comparison = compare(element, target);
        }
        if (comparison === 0) {
            return mid;
        }
